...
using Owin;
using WeTeam.API.Authorization;
using WeTeam.API.Providers;
using WeTeam.API.Models;
...
namespace WeTeam.API
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            GlobalConfiguration.Configuration.UseSqlServerStorage("WeTeam.Repository.Context");
            app.UseHangfireDashboard("/hangfire", new DashboardOptions
            {
                AuthorizationFilters = new[] { new HangFireAuthorize(), }
            });
